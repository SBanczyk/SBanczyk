...
### 💫 I am a **Junior .NET & SQL Developer** with 1 year of commercial experience.

### 💼 My Work History
**Junior .NET & SQL Support Application Developer** | *OpenSky Data Systems* | **January 2026 - Currently**
...
- Creating SQL queries for selecting, updating and deleting data and managing structure of Live / Production database systems.
- Writing C# and SQL code with clean code guidelines.
- Identyfing and solving software problems reported by international users using Jira and Confluence.
- Managing code repository using Git with Bitbucket.
- Creating and modifying product technical documentation.
